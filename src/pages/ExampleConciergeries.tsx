...
const ExampleConciergeries = () => {
  ...
  const mockups = [
    "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&h=1200&fit=crop",
    "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=1200&fit=crop",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-[60vh] min-h-[500px] bg-gradient-to-br from-[#071552] to-[#0a1d6b] overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=1920&h=1080&fit=crop')] bg-cover bg-center opacity-20" />
        <div className="relative h-full flex items-center justify-center text-center px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-white font-medium">Conciergeries</span>
            </div>
            <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-6xl text-white mb-6">
              Exemple de livret Welkom
            </h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Solution professionnelle pour gérer un nombre illimité de biens depuis une interface centralisée
            </p>
          </motion.div>
        </div>
      </section>
...
export default ExampleConciergeries;
