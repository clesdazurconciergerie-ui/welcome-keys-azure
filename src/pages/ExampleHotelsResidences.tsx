...
import { Building, Check, Sparkles, ArrowRight } from "lucide-react";
import { useRef } from "react";

const ExampleHotelsResidences = () => {
  ...
  const mockups = [
    "https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=800&h=1200&fit=crop",
    "https://images.unsplash.com/photo-1551882547-ff40c63fe5fa?w=800&h=1200&fit=crop",
    "https://images.unsplash.com/photo-1445019980597-93fa8acb246c?w=800&h=1200&fit=crop"
  ];
        ...
        <div className="relative h-full flex items-center justify-center text-center px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-white font-medium">Hôtels & résidences</span>
            </div>
            <h1 className="font-display font-bold text-4xl sm:text-5xl md:text-6xl text-white mb-6">
              Exemple de livret Welkom
            </h1>
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Solution entreprise avec branding personnalisé et support dédié pour les grands établissements
            </p>
          </motion.div>
        </div>
      </section>
...
export default ExampleHotelsResidences;
