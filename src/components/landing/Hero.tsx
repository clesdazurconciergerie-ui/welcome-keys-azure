      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.p 
              variants={itemVariants}
              className="mt-4 lg:mt-6 text-muted-foreground leading-relaxed"
            >
            ...
            <motion.div 
              variants={itemVariants}
              className="mt-6 lg:mt-8 flex flex-col sm:flex-row items-center lg:justify-start justify-center gap-3"
            >
              <Button
                size="lg"
            ...
            <motion.div 
              variants={itemVariants}
              className="mt-6 lg:mt-8 flex flex-wrap items-center justify-center lg:justify-start gap-4 lg:gap-6 text-sm text-muted-foreground"
            >
          ...
          >
            <div className="relative aspect-[4/3] lg:aspect-auto">
              <img 
                ...
                loading="eager"
                className="w-full max-w-md mx-auto rounded-[24px] shadow-2xl border border-border object-cover"
              />
            </div>
          </motion.div>
        </div>
