      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative w-full max-w-2xl rounded-2xl border border-[#C4A45B]/20 bg-[#061452] p-8 shadow-2xl shadow-[#C4A45B]/10"
          >
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-3">
              <button
                ...
                className="group flex flex-col items-center gap-3 rounded-xl border-2 border-[#C4A45B]/20 bg-white/5 px-4 py-7 text-white transition-all duration-200 hover:border-[#C4A45B]/60 hover:bg-[#C4A45B]/10 hover:shadow-lg hover:shadow-[#C4A45B]/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C4A45B]"
              >
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#C4A45B]/10 transition-colors group-hover:bg-[#C4A45B]/20">
                  <Sparkles className="h-7 w-7 text-[#C4A45B]" />
                </div>
