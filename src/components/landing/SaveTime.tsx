...
const SaveTime = () => {
  const testimonials = [
    { name: "Marie L.", avatar: "ML", text: "Plus besoin de répéter les infos !" },
    { name: "Thomas B.", avatar: "TB", text: "Un gain de temps incroyable" },
  ];
          ...
          >
            ...
            <div className="space-y-4 mb-8">
              {testimonials.map((t, i) => (
                <div key={i} className="flex items-center gap-3 p-4 bg-white rounded-[18px] border border-border">
            ...
            <Button 
              size="lg"
              variant="outline"
              className="h-12 px-6 rounded-[18px] border-2"
            >
              Voir comment
            </Button>
          </motion.div>
