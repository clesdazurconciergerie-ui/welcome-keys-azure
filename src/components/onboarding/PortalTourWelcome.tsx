...
interface PortalTourWelcomeProps {
  open: boolean;
  onStart: () => void;
  onSkip: () => void;
  title: string;
...
export function PortalTourWelcome({ open, onStart, onSkip, title, description }: PortalTourWelcomeProps) {
  return (
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          >
            <div className="relative rounded-2xl overflow-hidden">
              ...
              <div className="relative z-10 px-10 py-12 text-center space-y-8">
                ...
                >
                  En quelques étapes, vous allez découvrir les fonctionnalités principales de votre espace.
                </motion.p>
